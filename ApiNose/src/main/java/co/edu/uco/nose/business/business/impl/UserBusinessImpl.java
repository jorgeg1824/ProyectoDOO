...
public final class UserBusinessImpl implements UserBusiness {
	...
	public void registerNewUserInformation(UserDomain userDomain) {
		...
		// 1. Validar que la informacion sea consistente a nivel de tipo de dato, longitud,
		// obligatoriedad, formato, rango, reglas del objeto.
				
		// 2. Validar que no exista previamente otro usuario con el mismo tipo y numero de
		// identificacion.
				
		// 3. Validar que no existe previamente otro usuario con el mismo correo electronico.
